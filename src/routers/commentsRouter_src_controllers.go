...
func init() {
	...
	beego.GlobalControllerRouter["github.com/alastairruhm/guidor/src/controllers:UserController"] = append(beego.GlobalControllerRouter["github.com/alastairruhm/guidor/src/controllers:UserController"],
		beego.ControllerComments{
			Method: "Post",
			Router: `/`,
			AllowHTTPMethods: []string{"post"},
