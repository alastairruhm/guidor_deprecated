...
func processResponseEntity(resp *http.Response, entity interface{}, expectedStatus int) error {
	if err := processResponse(resp, expectedStatus); err != nil {
		return err
	}
...
func processResponse(resp *http.Response, expectedStatus int) error {
	if resp.StatusCode != expectedStatus {
		return errors.New("response status of " + resp.Status)
	}
	return nil
}
